...
import type { Tariffs } from './economics/tariffs'
import {
...
// /api/v1/organization-tariffs. We map between this and the
// camelCase Tariffs domain type at the API boundary so the rest of
// the frontend stays in TS-idiomatic style and the wire shape can
