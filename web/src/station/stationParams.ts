...
export const STATION_PARAMS: StationParamDef[] = [
  { key: 'pv_rated_kw', label: 'Номінальна потужність СЕС', unit: 'кВт', group: 'passport' },
  { key: 'ess_rated_kw', label: 'Номінальна потужність УЗЕ', unit: 'кВт', group: 'passport' },
  { key: 'ess_rated_kwh', label: 'Номінальна ємність УЗЕ', unit: 'кВт·год', group: 'passport' },
  { key: 'ess_count', label: 'Кількість шаф ESS', unit: 'шт', group: 'passport' },
  { key: 'pcs_count', label: 'Кількість PCS', unit: 'шт', group: 'passport' },
  { key: 'ess_soh_pct', label: 'SOH', unit: '%', group: 'passport' },
  {
...
export function formatParamDisplay(
  ...
  // Keep one decimal for SOH / power / capacity when needed.
