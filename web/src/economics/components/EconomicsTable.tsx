      ...
      <details className="economics-cost-basis-help">
        ...
        <div className="economics-cost-basis-help-body">
          ...
          <ul>
            ...
            <li>
              На 00:00 сьогодні залишок у кВт·год беремо з найточнішого
              доступного джерела: pre-roll вчорашніх потоків → SOC у момент
              опівночі → 0. А <strong>стартову ціну</strong> цього залишку
              задає окремий тариф «Стартова собівартість УЗЕ на 00:00» — це
              прямий override, що показує: «вся енергія, яка вже у батареї,
              коштує X грн/кВт·год».
            </li>
          </ul>
