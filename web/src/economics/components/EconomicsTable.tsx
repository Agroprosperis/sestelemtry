      ...
      <details className="economics-cost-basis-help">
        ...
        <div className="economics-cost-basis-help-body">
          ...
          <ul>
            ...
            <li>
              На 00:00 сьогодні стан переноситься з кінця вчорашньої доби
              (тим самим алгоритмом). Якщо вчорашніх потоків чи РДН немає,
              стартуємо із seed-параметра «Собівартість seed-залишку УЗЕ»
              у налаштуваннях тарифів.
            </li>
          </ul>
          <p className="economics-cost-basis-help-note">
            Тому коли більшість заряду — від СЕС, низька «Собівартість УЗЕ»
            (часто &lt; 0,30 грн/кВт·год) — це не помилка, а наслідок того, що
            операційно SES доливає у бакет «безплатні» кВт·год.
          </p>
        </div>
      </details>
    </section>
